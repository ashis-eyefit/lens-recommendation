...
- Vision Aid Preferences: {', '.join(data.preferences or ['None'])}
"""
...
def generate_system_prompt():
    return """
        ...
        📌 RULES:
        - Choose the most clinically suitable **lens_name** based on symptoms, age, screen time, vision history, user preferences or risk factors.
